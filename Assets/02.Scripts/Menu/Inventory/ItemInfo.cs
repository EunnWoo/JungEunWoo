...
public class ItemInfo : MonoBehaviour
{
    ...
    public void ReadAndParse()
    {
        ...
        ParseWearPart(strItemInfo, "wearpart");     //ParseWearPart 에서 wearpart 들만 뽑아낸다
        ParseUsePart(strItemInfo, "usepart");      //ParseWearPart 에서 usepart 들만 뽑아낸다
        ParseETCPart(strItemInfo, "etcpart");      //ParseWearPart 에서 etcpart 들만 뽑아낸다
    }
